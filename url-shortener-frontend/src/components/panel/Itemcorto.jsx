...
const Itemcorto = ({originalUrl, shortUrl, clickCount, createdDate}) => {
    ...
    const fetchShortUrl = async() => {
        setLoader(true);
        try {
            const {data} = await api.get(`https://url-shortener-sb-ktt9.onrender.com/api/urls/analytics/${selectedUrl}?startDate=2025-01-01T00:00:00&endDate=2025-05-20T23:59:59`,
                {
                            headers:{
            ...
            {loader ? (
                 <div className="min-h-[calc(450px-140px)] flex justify-center items-center w-full">
                    <div className="flex flex-col items-center gap-1">
                        ...
                        />
                        <p className="textslate-700">Un momento por favor...</p>
                    </div>
                </div>
            ) : (<>
                ...
                <Grafico GrafData={analyticsData}/>
            </>)
